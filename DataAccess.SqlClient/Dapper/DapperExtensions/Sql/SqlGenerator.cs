...
namespace DataAccess
{
    internal interface ISqlGenerator
    {
        ...
        //肖艳杰添加,添加基于SQL语句的分页方法
        string SelectPaged(string sql, int page, int resultsPerPage, out object parameters);
    ...
    internal class SqlGeneratorImpl : ISqlGenerator
    {
        ...
        public virtual string SelectPaged(string sql, int page, int resultsPerPage,
            out object parameters)
        {

            string newSql = Configuration.Dialect.GetPagingSql(sql, page, resultsPerPage,out parameters);
            return newSql;
        }
